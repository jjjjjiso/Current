...
namespace FullSerializer.Tests {
    public class IgnoreTypeTests {
        ...
        private class Model {
            ...
            public Model() { }
            public Model(IgnoredClass IgnoredClass, NotIgnoredClass NotIgnoredClass, IgnoredStruct IgnoredStruct, NotIgnoredStruct NotIgnoredStruct)
            {
                this.IgnoredClass = IgnoredClass;
                this.NotIgnoredClass = NotIgnoredClass;
                this.IgnoredStruct = IgnoredStruct;
                this.NotIgnoredStruct = NotIgnoredStruct;
            }
        }
